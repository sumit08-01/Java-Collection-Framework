...
public class VariableAssignments {
	...
	public static void main(String[] args) {
		...
		int[] c = {11,22};
		b = c;	
		c = b;	//both b and c will point same array c, No new array has been created and this {1,2,3} value for garbage Collector
		...
		// and No parent Child relationship b/w [S and [I that's why not promoted
